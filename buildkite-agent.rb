...
class BuildkiteAgent < Formula
  ...
  devel do
    version "2.1-beta.2"
    url     "https://github.com/buildkite/agent/releases/download/v2.1-beta.2/buildkite-agent-darwin-386-2.1-beta.2.tar.gz"
    sha1    "ea80266b02f2be3e08aaae66cfcb7e4e644b5952"
  end
