class BuildkiteAgent < Formula
  ...
  stable do
    version "2.6.8"
    url     "https://github.com/buildkite/agent/releases/download/v2.6.8/buildkite-agent-darwin-386-2.6.8.tar.gz"
    sha256  "8eb87a8755513f5e1003dec75df3ccbd4084c830b7c0473551d29e9abb073792"
  end

  devel do
    version "3.0-beta.37"
    url     "https://github.com/buildkite/agent/releases/download/v3.0-beta.37/buildkite-agent-darwin-386-3.0-beta.37.tar.gz"
    sha256  "c6652496f1d1750bc98cf24057d57a2b102730caa0fc47c18a62596976f8ae05"
  end
