...
class BuildkiteAgent < Formula
  ...
  stable do
    version "2.1.17"
    url     "https://github.com/buildkite/agent/releases/download/v2.1.17/buildkite-agent-darwin-386-2.1.17.tar.gz"
    sha256  "95ff2cbf82b4a1abae7caa0b3cf32f4730afa15aaa2cd4acd74509112943b6fb"
  end

  devel do
    version "3.0-beta.9"
    url     "https://github.com/buildkite/agent/releases/download/v3.0-beta.9/buildkite-agent-darwin-386-3.0-beta.9.tar.gz"
    sha256  "76432c19768585518896b93c0fa31bd910c69669293d0d9110c0643bd578675e"
  end
