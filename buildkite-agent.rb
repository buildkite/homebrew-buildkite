...
class BuildkiteAgent < Formula
  ...
  stable do
    version "2.5"
    url     "https://github.com/buildkite/agent/releases/download/v2.5/buildkite-agent-darwin-386-2.5.tar.gz"
    sha256  "9f231819db2abd02fdf2e6d6e1155feafb93bc19ef2e3d3cdd94afea3fba0d10"
  end
