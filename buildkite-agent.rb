...
class BuildkiteAgent < Formula
  ...
  stable do
    version "2.4"
    url     "https://github.com/buildkite/agent/releases/download/v2.4/buildkite-agent-darwin-386-2.4.tar.gz"
    sha256  "ca7be2c7d59f795f56f49b976dae71dce9f5768956a4e6e7b5f483d949903db3"
  end
