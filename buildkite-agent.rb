...
class BuildkiteAgent < Formula
  ...
  devel do
    version "1.0-beta.38"
    url     "https://github.com/buildkite/agent/releases/download/v1.0-beta.38/buildkite-agent-darwin-386-1.0-beta.38.712.tar.gz"
    sha1    "71eed1b84ca1264cfc89f02e4e30fe61d95d1bdc"
  end
