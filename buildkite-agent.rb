...
class BuildkiteAgent < Formula
  ...
  devel do
    version "1.0-beta.37"
    url     "https://github.com/buildkite/agent/releases/download/v1.0-beta.37/buildkite-agent-darwin-386-1.0-beta.37.696.tar.gz"
    sha1    "b4ecb0f1d0cb34e68ac7a306b3984479da979ab6"
  end
