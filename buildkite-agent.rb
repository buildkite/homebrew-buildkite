...
class BuildkiteAgent < Formula
  ...
  devel do
    version "1.0-beta.26"
    url     "https://github.com/buildkite/agent/releases/download/v1.0-beta.26/buildkite-agent-darwin-386-1.0-beta.26.474.tar.gz"
    sha1    "535f96ba1a92018605c6f878116138b8087deab0"
  end
