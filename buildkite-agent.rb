class BuildkiteAgent < Formula
  ...
  stable do
    version "2.6.10"
    url     "https://github.com/buildkite/agent/releases/download/v2.6.10/buildkite-agent-darwin-386-2.6.10.tar.gz"
    sha256  "7eed603c37f9431da10beee270b4abc66c7c21ab2b6588f32966452a5b6e3364"
  end

  devel do
    version "3.0-beta.44"
    url     "https://github.com/buildkite/agent/releases/download/v3.0-beta.44/buildkite-agent-darwin-386-3.0-beta.44.tar.gz"
    sha256  "e497d15a12813c69a21d26e23fad2f2a3c3b1ab5faadc25fddbbcfafe04ce260"
  end
