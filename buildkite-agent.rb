...
class BuildkiteAgent < Formula
  ...
  devel do
    version "1.0-beta.40"
    url     "https://github.com/buildkite/agent/releases/download/v1.0-beta.40/buildkite-agent-darwin-386-1.0-beta.40.739.tar.gz"
    sha1    "85f7c639f694166c2d0e22f09c0f3bd88a92f236"
  end
