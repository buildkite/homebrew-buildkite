...
class BuildkiteAgent < Formula
  ...
  stable do
    version "2.3.2"
    url     "https://github.com/buildkite/agent/releases/download/v2.3.2/buildkite-agent-darwin-386-2.3.2.tar.gz"
    sha256  "39a1dc2216fd980ad079dd7b56dc58cd69fb7166094e3f7aefa0b521e69ad0c1"
  end

  devel do
    version "3.0-beta.15"
    url     "https://github.com/buildkite/agent/releases/download/v3.0-beta.15/buildkite-agent-darwin-386-3.0-beta.15.tar.gz"
    sha256  "a9b9341cba30ea1128dbb5711191c2341a6072ad1a164d503659a657908ba9b8"
  end
