class BuildkiteAgent < Formula
  ...
  stable do
    version "2.6.6"
    url     "https://github.com/buildkite/agent/releases/download/v2.6.6/buildkite-agent-darwin-386-2.6.6.tar.gz"
    sha256  "2ecc77d18447d8436aac492072f511fbef76de6c8abd155bed6a8a2ce23d1aec"
  end

  devel do
    version "3.0-beta.34"
    url     "https://github.com/buildkite/agent/releases/download/v3.0-beta.34/buildkite-agent-darwin-386-3.0-beta.34.tar.gz"
    sha256  "ed82eace640646f20dfc031c6bf020c4d8dcc0422967d825566d67e3b850388f"
  end
