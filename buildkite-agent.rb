...
class BuildkiteAgent < Formula
  ...
  stable do
    version "2.1.12"
    url     "https://github.com/buildkite/agent/releases/download/v2.1.12/buildkite-agent-darwin-386-2.1.12.tar.gz"
    sha1    "ec41181e9d9b6174d8dc87aa8e308779eaeb69ad"
  end

  devel do
    version "3.0-beta.1"
    url     "https://github.com/buildkite/agent/releases/download/v3.0-beta.1/buildkite-agent-darwin-386-3.0-beta.1.tar.gz"
    sha1    "d6a07c1f8d2d63176a769a7817b2d06e348d8953"
  end
