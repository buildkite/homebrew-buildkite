...
class BuildkiteAgent < Formula
  ...
  stable do
    version "2.3"
    url     "https://github.com/buildkite/agent/releases/download/v2.3/buildkite-agent-darwin-386-2.3.tar.gz"
    sha256  "b09a3bf92e01ab6817dd61d2f7a64aa4918b5011913af34d00b5df81de91b605"
  end
