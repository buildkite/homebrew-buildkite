...
class BuildkiteAgent < Formula
  ...
  devel do
    version "1.0-beta.24"
    url     "https://github.com/buildkite/agent/releases/download/v1.0-beta.24/buildkite-agent-darwin-386-1.0-beta.24.465.tar.gz"
    sha1    "49a12c5d674d93fb874721800aeb5882225b08c8"
  end
