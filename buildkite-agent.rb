...
class BuildkiteAgent < Formula
  ...
  stable do
    version "2.1.10"
    url     "https://github.com/buildkite/agent/releases/download/v2.1.10/buildkite-agent-darwin-386-2.1.10.tar.gz"
    sha1    "dc4a27bbdafdc56f13b03b36cdd65075a5ae5a1c"
  end

  devel do
    version "2.2-beta.4"
    url     "https://github.com/buildkite/agent/releases/download/v2.2-beta.4/buildkite-agent-darwin-386-2.2-beta.4.tar.gz"
    sha1    "d1410a4c24fe76a8215aa6d795e1e5de4eac8227"
  end
