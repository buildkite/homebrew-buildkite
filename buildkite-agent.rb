...
class BuildkiteAgent < Formula
  ...
  stable do
    version "2.1.16"
    url     "https://github.com/buildkite/agent/releases/download/v2.1.16/buildkite-agent-darwin-386-2.1.16.tar.gz"
    sha1    "07bd19131ce6b7a6955a263799776964a7344d3c"
    sha256  "08f38d71cd8b8e38934fbe6aeddf08c8e98f7ec5ba048e337567ecbdbc00e4ef"
  end

  devel do
    version "3.0-beta.6"
    url     "https://github.com/buildkite/agent/releases/download/v3.0-beta.6/buildkite-agent-darwin-386-3.0-beta.6.tar.gz"
    sha1    "95e042e4e56b6da54846a514b1f2f28b991f648f"
    sha256  "4c2b91a5254e3dca4579927fffd6b52082e5724535075a36a3e3e0ecbbc0cd3f"
  end
