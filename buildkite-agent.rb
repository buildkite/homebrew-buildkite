...
class BuildkiteAgent < Formula
  ...
  devel do
    version "3.0-beta.3"
    url     "https://github.com/buildkite/agent/releases/download/v3.0-beta.3/buildkite-agent-darwin-386-3.0-beta.3.tar.gz"
    sha1    "9dacc0c2881fbd386b0a75c391ab1706ec77d778"
  end
