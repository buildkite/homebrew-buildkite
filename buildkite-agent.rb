...
class BuildkiteAgent < Formula
  ...
  devel do
    version "1.0-beta.29"
    url     "https://github.com/buildkite/agent/releases/download/v1.0-beta.29/buildkite-agent-darwin-386-1.0-beta.29.508.tar.gz"
    sha1    "31f18eefdce3da81933bf0932c0ed1f0e418c375"
  end
