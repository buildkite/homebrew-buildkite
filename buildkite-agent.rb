class BuildkiteAgent < Formula
  ...
  stable do
    version "2.6.5"
    url     "https://github.com/buildkite/agent/releases/download/v2.6.5/buildkite-agent-darwin-386-2.6.5.tar.gz"
    sha256  "08a4316a8c923be12085684e3ce185855990fe77ab99427f6c6dcec487c3091d"
  end

  devel do
    version "3.0-beta.28"
    url     "https://github.com/buildkite/agent/releases/download/v3.0-beta.28/buildkite-agent-darwin-386-3.0-beta.28.tar.gz"
    sha256  "bc39231ecdb52e7c7dedaa552234038c91d88b935f6e14a6dee212269480c44a"
  end
