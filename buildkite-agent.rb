...
class BuildkiteAgent < Formula
  ...
  devel do
    version "3.0-beta.2"
    url     "https://github.com/buildkite/agent/releases/download/v3.0-beta.2/buildkite-agent-darwin-386-3.0-beta.2.tar.gz"
    sha1    "caac096633848cfaf575a1d2b98733da51ee0785"
  end
