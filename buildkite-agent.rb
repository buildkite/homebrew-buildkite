...
class BuildkiteAgent < Formula
  ...
  devel do
    version "1.0-beta.25"
    url     "https://github.com/buildkite/agent/releases/download/v1.0-beta.25/buildkite-agent-darwin-386-1.0-beta.25.470.tar.gz"
    sha1    "f343007ada76e3b4cb530408e3ed0a52f4231a6f"
  end
