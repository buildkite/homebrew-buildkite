...
class BuildkiteAgent < Formula
  ...
  devel do
    version "1.0-beta.27"
    url     "https://github.com/buildkite/agent/releases/download/v1.0-beta.27/buildkite-agent-darwin-386-1.0-beta.27.477.tar.gz"
    sha1    "9caa26031716cd5f93719595f0b6bcfa9e56bf64"
  end
