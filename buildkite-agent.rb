...
class BuildkiteAgent < Formula
  ...
  stable do
    version "2.6.2"
    url     "https://github.com/buildkite/agent/releases/download/v2.6.2/buildkite-agent-darwin-386-2.6.2.tar.gz"
    sha256  "c24c82f1cce0e3cf63dd6cd63383561ba784490930d8c57441c076bf32e17d49"
  end

  devel do
    version "3.0-beta.21"
    url     "https://github.com/buildkite/agent/releases/download/v3.0-beta.21/buildkite-agent-darwin-386-3.0-beta.21.tar.gz"
    sha256  "bf8269a26d96791eababd0dd878d2f922e8239b23738e1986cb291a88ee8809e"
  end
