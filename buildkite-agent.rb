...
class BuildkiteAgent < Formula
  ...
  devel do
    version "2.2-beta.3"
    url     "https://github.com/buildkite/agent/releases/download/v2.2-beta.3/buildkite-agent-darwin-386-2.2-beta.3.tar.gz"
    sha1    "f775971eb104defb59fa237a494a31999b0a6fac"
  end
