class BuildkiteAgent < Formula
  ...
  stable do
    version "2.6.3"
    url     "https://github.com/buildkite/agent/releases/download/v2.6.3/buildkite-agent-darwin-386-2.6.3.tar.gz"
    sha256  "0c16fad0a8fee2dc8bde18983bab0f9f4501562d4659c49610177bf740da7caa"
  end

  devel do
    version "3.0-beta.24"
    url     "https://github.com/buildkite/agent/releases/download/v3.0-beta.24/buildkite-agent-darwin-386-3.0-beta.24.tar.gz"
    sha256  "c2d8d747a7232af5ebc8121a3d7173d6499fe93184b6493035161493e743698c"
  end
