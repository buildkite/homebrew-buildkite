...
class BuildkiteAgent < Formula
  ...
  devel do
    version "1.0-beta.21"
    url     "https://github.com/buildkite/agent/releases/download/v1.0-beta.21/buildkite-agent-darwin-386-1.0-beta.21.432.tar.gz"
    sha1    "9bb933687f0c00c99942a25a861b7de926a38406"
  end
