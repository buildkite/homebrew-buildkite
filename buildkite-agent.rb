...
class BuildkiteAgent < Formula
  ...
  devel do
    version "1.0-beta.39"
    url     "https://github.com/buildkite/agent/releases/download/v1.0-beta.39/buildkite-agent-darwin-386-1.0-beta.39.724.tar.gz"
    sha1    "8e2819e6faf77b4c0518d5c2561e2e0409a01f68"
  end
