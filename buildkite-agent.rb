...
class BuildkiteAgent < Formula
  ...
  devel do
    version "1.0-beta.36"
    url     "https://github.com/buildkite/agent/releases/download/v1.0-beta.36/buildkite-agent-darwin-386-1.0-beta.36.684.tar.gz"
    sha1    "5ccb19b3294751faf88e5e67fce7eda13705999c"
  end
