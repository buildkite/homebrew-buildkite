...
class BuildkiteAgent < Formula
  ...
  devel do
    version "1.0-beta.32"
    url     "https://github.com/buildkite/agent/releases/download/v1.0-beta.32/buildkite-agent-darwin-386-1.0-beta.32.583.tar.gz"
    sha1    "7fd9dd70f1f2395787ae53b9feabfede1a165437"
  end
