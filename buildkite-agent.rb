...
class BuildkiteAgent < Formula
  ...
  stable do
    version "2.6.0"
    url     "https://github.com/buildkite/agent/releases/download/v2.6.0/buildkite-agent-darwin-386-2.6.0.tar.gz"
    sha256  "3fa62ec5fc0c2d74cbe524eb279fc5d0c61c9b107ba7afd94f1a266796a193fc"
  end

  devel do
    version "3.0-beta.20"
    url     "https://github.com/buildkite/agent/releases/download/v3.0-beta.20/buildkite-agent-darwin-386-3.0-beta.20.tar.gz"
    sha256  "377d5c9b422b9bd86e884f9e0dcaad1b6df008881cda50a36f6089b1bd5f4ec7"
  end
