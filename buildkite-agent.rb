...
class BuildkiteAgent < Formula
  ...
  devel do
    version "1.0-beta.35"
    url     "https://github.com/buildkite/agent/releases/download/v1.0-beta.35/buildkite-agent-darwin-386-1.0-beta.35.661.tar.gz"
    sha1    "963adb72f656b715268572503a93aed2fe8d5c3b"
  end
