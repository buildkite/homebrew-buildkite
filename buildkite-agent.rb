...
class BuildkiteAgent < Formula
  ...
  stable do
    version "2.1.4"
    url     "https://github.com/buildkite/agent/releases/download/v2.1.4/buildkite-agent-darwin-386-2.1.4.tar.gz"
    sha1    "924941c2bf90e1abcd04a3dba1d416d751211a9a"
  end

  devel do
    version "2.1-beta.3"
    url     "https://github.com/buildkite/agent/releases/download/v2.1-beta.3/buildkite-agent-darwin-386-2.1-beta.3.tar.gz"
    sha1    "44151c8474b192c34b9ca41f65beb2b342c4e005"
  end
