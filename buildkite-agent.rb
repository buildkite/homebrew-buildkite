...
class BuildkiteAgent < Formula
  ...
  stable do
    version "2.1.7"
    url     "https://github.com/buildkite/agent/releases/download/v2.1.7/buildkite-agent-darwin-386-2.1.7.tar.gz"
    sha1    "7fcb9360bd8521464739ec34b0204584c79ae569"
  end

  devel do
    version "2.2-beta.2"
    url     "https://github.com/buildkite/agent/releases/download/v2.2-beta.2/buildkite-agent-darwin-386-2.2-beta.2.tar.gz"
    sha1    "14831ce9dcfe4eaaaa0912e043a4e565effd3419"
  end
